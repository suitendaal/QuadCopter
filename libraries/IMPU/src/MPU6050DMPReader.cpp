...
// I Simplified this:
uint8_t MPU6050DMPReader::dmpInitialize() {
	// reset device
	DEBUG_PRINTLN(F("\n\nResetting MPU6050..."));
	reset();
...
bool MPU6050DMPReader::dmpPacketAvailable() {
...
uint8_t MPU6050DMPReader::dmpGetAccel(int32_t* data, const uint8_t* packet) {
...
uint8_t MPU6050DMPReader::dmpGetAccel(int16_t* data, const uint8_t* packet) {
	// TODO: accommodate different arrangements of sent data (ONLY default supported now)
	if (packet == 0) packet = dmpPacketBuffer;
...
uint8_t MPU6050DMPReader::dmpGetAccel(VectorInt16 &v, const uint8_t* packet) {
	// TODO: accommodate different arrangements of sent data (ONLY default supported now)
	if (packet == 0) packet = dmpPacketBuffer;
...
uint8_t MPU6050DMPReader::dmpGetQuaternion(int32_t* data, const uint8_t* packet) {
	// TODO: accommodate different arrangements of sent data (ONLY default supported now)
	if (packet == 0) packet = dmpPacketBuffer;
...
uint8_t MPU6050DMPReader::dmpGetQuaternion(int16_t* data, const uint8_t* packet) {
	// TODO: accommodate different arrangements of sent data (ONLY default supported now)
	if (packet == 0) packet = dmpPacketBuffer;
...
uint8_t MPU6050DMPReader::dmpGetQuaternion(Quaternion &q, const uint8_t* packet) {
	// TODO: accommodate different arrangements of sent data (ONLY default supported now)
	int16_t qI[4];
...
uint8_t MPU6050DMPReader::dmpGetGyro(int32_t* data, const uint8_t* packet) {
	// TODO: accommodate different arrangements of sent data (ONLY default supported now)
	if (packet == 0) packet = dmpPacketBuffer;
...
uint8_t MPU6050DMPReader::dmpGetGyro(int16_t* data, const uint8_t* packet) {
	// TODO: accommodate different arrangements of sent data (ONLY default supported now)
	if (packet == 0) packet = dmpPacketBuffer;
...
uint8_t MPU6050DMPReader::dmpGetGyro(VectorInt16* v, const uint8_t* packet) {
	// TODO: accommodate different arrangements of sent data (ONLY default supported now)
	if (packet == 0) packet = dmpPacketBuffer;
...
uint8_t MPU6050DMPReader::dmpGetLinearAccel(VectorInt16 &v, VectorInt16 &vRaw, VectorFloat &gravity) {
...
uint8_t MPU6050DMPReader::dmpGetLinearAccelInWorld(VectorInt16 &v, VectorInt16 &vReal, Quaternion &q) {
...
uint8_t MPU6050DMPReader::dmpGetGravity(int16_t* data, const uint8_t* packet) {
...
uint8_t MPU6050DMPReader::dmpGetGravity(VectorFloat &v, Quaternion &q) {
...
uint8_t MPU6050DMPReader::dmpGetEuler(float* data, Quaternion &q) {
...
#else 
uint8_t MPU6050DMPReader::dmpGetYawPitchRoll(float* data, Quaternion &q, VectorFloat &gravity) {
	// yaw: (about Z axis)
	data[0] = atan2(2 * q.x * q.y - 2 * q.w * q.z, 2 * q.w * q.w + 2 * q.x * q.x - 1);
	// pitch: (nose up/down, about Y axis)
...
uint8_t MPU6050DMPReader::dmpProcessFIFOPacket(const unsigned char* dmpData) {
...
uint8_t MPU6050DMPReader::dmpReadAndProcessFIFOPacket(uint8_t numPackets, uint8_t* processed) {
	uint8_t status;
...
uint16_t MPU6050DMPReader::dmpGetFIFOPacketSize() {
	return dmpPacketSize;
}



uint8_t MPU6050DMPReader::dmpGetCurrentFIFOPacket(uint8_t* data) { // overflow proof
